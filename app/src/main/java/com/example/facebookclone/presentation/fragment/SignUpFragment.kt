...
class SignUpFragment : BaseFragment<FragmentSignUpBinding>(FragmentSignUpBinding::inflate) {
    ...
    private fun initAction() {
        ...
        binding.apply {
            ...
            btnSignUp.setOnClickListener {
                if (mViewModel.isDetailsCompleted()) {
                    if (!mViewModel.validateEmailAddress()) {
                        showSnackbar(
                            binding.edtMobNo,
                            resources.getString(R.string.email_address_warning)
                        )
                    } else if (!mViewModel.validatePhoneNumber()) {
                        showSnackbar(
                            binding.edtEmail,
                            resources.getString(R.string.mobile_number_digits_warning)
                    ...
                    showToast(resources.getString(R.string.fill_all_details))
                }
    ...
    private fun initGenderAdapter() {
        ...
        binding.genderSpinner.setSelection(
            getPosition(
                genderItems,
                mViewModel.updatedUserData.gender
            )
        )
            ...
            object : AdapterView.OnItemSelectedListener {
                override fun onItemSelected(
                    ...
                    if (position == 0) {
                        ...
                        mViewModel.updatedUserData.gender = genderItems[position]
                    }
                }
        ...
        showLog("Gender is ${mViewModel.updatedUserData.gender}")
    }
